...
#  define __CUSTOM_EEPROM_SIZE 2
#  define __CUSTOM_SRAM_SIZE   32k
...
memory STM32L1xx_SRAM
{
    mau = 8;
    type = ram;
    size = __CUSTOM_SRAM_SIZE;
    map ( size = __CUSTOM_SRAM_SIZE, dest_offset=0x20000000, dest=bus:ARM:local_bus);
}
...
memory STM32L1xx_EEPROM
{
    mau = 8;
    type = reserved rom;
    size = __CUSTOM_EEPROM_SIZE;
    map ( size = __CUSTOM_EEPROM_SIZE, dest_offset=0x08080000, dest=bus:ARM:local_bus);
}


section_layout ::linear
{
    group discover_functions (attributes=rs, run_addr=mem:STM32L1xx_EEPROM) 
    {
         select ".bss.STM32L1xx_EEPROM";
    }
}
...
section_setup ::linear
{
                                            ...
                                            )
                {
                        ...
                        vector ( id = 62, optional, fill = "TIM5_IRQHandler" );                 // TIM5
                        vector ( id = 63, optional, fill = "SPI3_IRQHandler" );                 // SPI3
                        vector ( id = 66, optional, fill = "DMA2_Channel1_IRQHandler" );  // DMA2 Channel 1
                        vector ( id = 67, optional, fill = "DMA2_Channel2_IRQHandler" );    // DMA2 Channel 2
                        vector ( id = 68, optional, fill = "DMA2_Channel3_IRQHandler" );    // DMA2 Channel 3
                        vector ( id = 69, optional, fill = "DMA2_Channel4_IRQHandler" );    // DMA2 Channel 4
                        vector ( id = 70, optional, fill = "DMA2_Channel5_IRQHandler" );    // DMA2 Channel 5
                        vector ( id = 71, optional, fill = "AES_IRQHandler" );              // AES
