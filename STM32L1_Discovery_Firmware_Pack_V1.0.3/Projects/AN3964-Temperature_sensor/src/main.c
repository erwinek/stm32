...
//RCC_APB2PeriphClockCmd(RCC_APB2Periph_USART1 | RCC_AHBPeriph_GPIOA | RCC_AHBPeriph_AFIO, ENABLE);
...
if(TIM3->SR & TIM_SR_UIF) // if UIF flag is set
  ...
  GPIO_TOGGLE(LD_GPIO_PORT, LD_GREEN_GPIO_PIN); // toggle LED state
  }
}
//=============================================================================
// End of file
